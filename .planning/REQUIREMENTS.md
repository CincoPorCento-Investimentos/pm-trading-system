...
- [ ] **CORE-01**: Modulo Maven `hft-synthetic-monitoring` com pom.xml, package structure e entry point Spring Boot
- [ ] **CORE-02**: Configuracao externalizada via `MonitoringProperties` (@ConfigurationProperties) com todos os parametros do application.yml
